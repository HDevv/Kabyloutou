...
export const products = [
  ...
  // Nouvelles machines ajoutées récemment
  { slug: 'motobineuse-4-fraises-v2', name: 'Motobineuse 4 fraises (v2)', price: 30, unit: 'jour', image: '/outils/Motobineuse4fraises.jpg', desc: 'Motobineuse compacte 4 fraises.', longDesc: 'Motobineuse thermique 4 fraises, version compacte et maniable. Parfaite pour petits jardins et espaces restreints.' },
  { slug: 'motobineuse-6-fraises',     name: 'Motobineuse 6 fraises',     price: 38, unit: 'jour', image: '/outils/Motobineuse6fraises.jpg', desc: 'Motobineuse puissante 6 fraises.', longDesc: 'Motobineuse thermique 6 fraises pour travaux intensifs. Largeur de travail étendue, idéale pour grands jardins.' }
];
